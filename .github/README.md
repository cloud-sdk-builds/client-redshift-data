...
[`@aws-sdk/client-redshift-data`](https://www.npmjs.com/package/@aws-sdk/client-redshift-data/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-redshift-data@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6Zh2ON0KOPSGEWwYQ8r1LUfphBuCP4wUyyiODb3j2lrLVrTLl++9hXqQ544oDOOk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-redshift-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-redshift-data@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-redshift-data@3.567.0/index.min.mjs": "sha384-6Zh2ON0KOPSGEWwYQ8r1LUfphBuCP4wUyyiODb3j2lrLVrTLl++9hXqQ544oDOOk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-redshift-data/blob/refs/tags/3.567.0/LICENSE
```
