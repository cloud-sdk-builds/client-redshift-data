...
[`@aws-sdk/client-redshift-data`](https://www.npmjs.com/package/@aws-sdk/client-redshift-data/v/3.1123.0).
...
- @aws-sdk/client-redshift-data v3.1123.0 - [https://cloud-sdk-builds.github.io/?sdk=client-redshift-data&version=3.1123.0](https://cloud-sdk-builds.github.io/?sdk=client-redshift-data&version=3.1123.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-redshift-data@3.1123.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aOVWhPj7QeZGe9ncWRjOk4hZjgHSf0+5mVAMWPHI0YOTNDHXqfmcwZSmk8sG7EU1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-redshift-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-redshift-data@3.1123.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-redshift-data@3.1123.0/index.min.mjs": "sha384-aOVWhPj7QeZGe9ncWRjOk4hZjgHSf0+5mVAMWPHI0YOTNDHXqfmcwZSmk8sG7EU1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-redshift-data/blob/refs/tags/3.1123.0/LICENSE
```
