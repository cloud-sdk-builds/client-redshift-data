...
[`@aws-sdk/client-redshift-data`](https://www.npmjs.com/package/@aws-sdk/client-redshift-data/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-redshift-data@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4Hbmyhvmhba//Dy7VUDLolIEnBDADSO0rAG2MZ18RhSoty4oXymIVzymuE3um5YE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-redshift-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-redshift-data@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-redshift-data@3.855.0/index.min.mjs": "sha384-4Hbmyhvmhba//Dy7VUDLolIEnBDADSO0rAG2MZ18RhSoty4oXymIVzymuE3um5YE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-redshift-data/blob/refs/tags/3.855.0/LICENSE
```
